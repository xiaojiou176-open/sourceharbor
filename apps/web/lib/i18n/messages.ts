		...
		subscriptionsPage: {
			...
			placeholders: {
				...
				manualIntake: {
					...
					hint:
						"One line per input. Bilibili creator pages and YouTube handles save subscriptions; direct video URLs add to today; direct article URLs still return an honest unsupported result.",
			...
			placeholders: {
				...
				manualIntake: {
					...
					placeholder:
						"https://space.bilibili.com/13416784\nhttps://www.youtube.com/@MindAmend\nhttps://www.youtube.com/watch?v=dQw4w9WgXcQ\n/36kr/newsflashes\nhttps://example.com/feed.xml",
					hint:
						"一行一个输入。Bilibili 空间页和 YouTube handle 会保存成订阅；直链视频会直接进今天；直链文章 URL 目前会诚实返回 unsupported。",
