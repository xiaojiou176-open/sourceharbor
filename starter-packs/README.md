...
| prepare a Codex-compatible plugin bundle | `starter-packs/codex/sourceharbor-codex-plugin/` | plugin-grade local bundle today; official Codex listing still unavailable for self-serve publishing |
...
| prepare OpenClaw / ClawHub packaging metadata | `starter-packs/openclaw/clawhub.package.template.json` | publish-ready metadata template today, still not proof of ClawHub publication |
| prepare official MCP Registry metadata | `starter-packs/mcp-registry/README.md` | registry metadata template today, still not proof of official registry publication |
