...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `docs/assets/sourceharbor-hero.svg` | `svg` | `supporting-front-door-poster` | `docs/media-kit.md` | `repository-tracked-source-file` | `maintainer-assertion-required` | `non-runtime-illustration` | `currently-published-in-repo` | `yes` |
...
| `docs/assets/sourceharbor-studio-preview.svg` | `svg` | `readme-front-door-preview` | `README.md`<br>`docs/see-it-fast.md` | `repository-tracked-source-file` | `maintainer-assertion-required` | `non-runtime-illustration` | `currently-published-in-repo` | `yes` |
...
| `docs/assets/sourceharbor-builder-loop.svg` | `svg` | `builder-loop` | `docs/media-kit.md` | `repository-tracked-source-file` | `maintainer-assertion-required` | `non-runtime-illustration` | `currently-published-in-repo` | `yes` |
